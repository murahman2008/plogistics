<?php
	...
	class Basic_Barcode
	{
		...
		public static $code_type = "code128";
		public static $file_path;
		
		/**
		 * This function checks if the barcode image exists in the system
		 * @param String $text
		 * @return string|boolean
		 */
		private static function _checkBarcodeExists($text)
		{
			if(file_exists(self::$file_path.$text.".png"))
				return self::$file_path.$text.".png";
		...
		public static function generateBarcode($text)
		{
			...
			if ( in_array(strtolower(self::$code_type), array("code128", "code128b")) ) {
				...
				$chksum = 103;
				self::$text = strtoupper(self::$text); // Code 128A doesn't support lower case
				// Must not change order of array elements as the checksum depends on the array's key to validate final code
